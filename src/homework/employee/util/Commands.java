...
public interface Commands {
    ...
    String PRINT_ALL_COMPANIES = "11";
        ...
        System.out.println("Please input "+ADD_EMPLOYEE+" for add an employee");
        System.out.println("Please input "+ADD_COMPANY+" for add a company");
        System.out.println("Please input "+PRINT_EMPLOYEES+" for printing all employees database");
        System.out.println("Please input "+SEARCH_EMPLOYEE_BY_ID+" for searching employee by id");
        System.out.println("Please input "+SEARCH_EMPLOYEE_BY_COMPANY+" for searching employee by company");
        System.out.println("Please input "+SEARCH_EMPLOYEE_BY_SALARY_RANGE+" for searching employee by salary range");
